...
public class FeathersEmitterProvider implements EventListenerProvider {

    private static final Logger log = Logger.getLogger(FeathersEmitterProvider.class);

    private final KeycloakSession session;
    private final RealmProvider model;

    public FeathersEmitterProvider(KeycloakSession session) {
    ...
    private void sendUserData(UserModel user) {
        String data =
                "{\"id\": " + user.getId() + "\"," +
                        ...
                        "}";
        try {
            FeathersEmitter.postEvent(data);
